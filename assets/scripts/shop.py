...
class InfoBar:
    def __init__(self, font:pygame.font.Font):
        ...
        self.info_dict = {117: "Ordinary spike, kills enemies and player on contact. Destroyed after killing one enemy. Spikes can be placed anywhere, and spikes in the game or placed by the player be shapeshifted into anything except swinging axes. Takes 1 shapeshift to use.", 118: "Hidden Spike, erupts from ground and kills enemies and player on contact. Destroyed after killing two enemies. Hidden spikes can be placed anywhere, but hidden spikes in the game or placed by player can ONLY be shifted into standard tile. Takes 1 shapeshift to use.", 121: "Swinging axe, kills enemies and player on contact. Destroyed after killing 3 enemies. Periodically swings high enough to let player or enemies pass. Takes 3 shapeshifts to use. Swinging axes be placed anywhere but axes in the game or placed by player cannot be shapeshifted into anything else.", 116: "Fire Platform, periodically emits blasts of flames which kill player and enemies on contact. Permanent and never destroyed unless shapeshifted by player. Safe to walk accross while not burning. Takes 4 shapeshifts to use. Can be placed anywhere and shapeshifted into anything.", 6: "Standard ground tile. Can be placed anywhere and shapeshifted into anything. Takes 1 shapeshift to use.", 200: "Wooden shield, blocks enemy attacks from killing player. Only blocks attacks if they touch the shield. Has 8 health. Breaks upon reaching 0 health but respawns when player dies and respawns. Control shield direction with Z and X.", 201: "Iron shield, blocks enemy attacks from killing player. Only blocks attacks if they touch the shield. Has 16 health. Breaks upon reaching 0 health but respawns when player dies and respawns. Control shield direction with Z and X. Control shield direction with Z and X.", 202: "Golden shield, blocks enemy attacks from killing player. Only blocks attacks if they touch the shield. Has 24 health. Breaks upon reaching 0 health but respawns when player dies and respawns. Control shield direction with Z and X.", 203: "Diamond shield, blocks enemy attacks from killing player. Only blocks attacks if they touch the shield. Has 32 health. Breaks upon reaching 0 health but respawns when player dies and respawns. Control shield direction with Z and X."}
